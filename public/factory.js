...
(function() {
  angular.module('west-dbms', []).factory('DBMS', function($http) {
    var about, contact, news, notify, policy_list, publish_news, slides, user;
    user = {};
    publish_news = {
      title: "",
      content: "",
      create: function() {
        ...
        return $http.post("/news", publish_news).then(function(res) {
          news.push(res.data);
          return alert("Published successfully");
        });
      },
      update: function(id) {
        return $http.post("/news/" + id, publish_news).then(function(res) {
    ...
    about = "<p> &nbsp;&nbsp;&nbsp;&nbsp;中国西部研究与发展促进会健康中国推进工作委员会，是中国西部研究与发展促进会的直属机构。<br> &nbsp;&nbsp;&nbsp;&nbsp;委员会以党的科学发展观为指导，促进我国西部地区健康中国战略推进工作有序发展为目标，认真做好改善西部地区医疗卫生条件、促进人才与信息交流、为有需要的地区提供医疗卫生帮扶工作。为政府主管部门和医疗卫生领域的科研机构、生产企业、设计、检测机构、大专院校、学术团体提供服务；协调政府机构或组织与企业之间、医疗卫生科研机构与企业之间、企业与企业之间、医疗卫生产品与用户之间的关系，发挥桥梁与纽带作用，促进我国医疗公共卫生事业的健康发展。<br> &nbsp;&nbsp;&nbsp;&nbsp;委员会办公地点设在北京。<br> </p>";
