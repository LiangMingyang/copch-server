...
(function() {
  angular.module('west-dbms', []).factory('DBMS', function($http) {
    var news, policies, policy_list, richtext, slides, user;
    user = {
      id: void 0,
      username: void 0,
      nickname: void 0,
    ...
    news = {
      ...
      dic: {},
      refresh: function() {
        return $http.get("/news").then(function(res) {
      ...
      "delete": function(_news) {
        return $http["delete"]("/news/" + _news.id).then(function(res) {
    ...
    richtext = {
      ...
      update: function(rt) {
        return $http.post("/richtext", rt).then(function(res) {
          rt = res.data;
          return richtext[rt.name].content = rt.content;
        })["catch"](function(err) {
          return console.log(err);
        });
      }
    ...
    policies = {
      ...
      dic: {},
      refresh: function() {
        return $http.get("/policies").then(function(res) {
          var _policies, i, j, len, ref, results;
          ...
          for (i = j = 0, len = ref.length; j < len; i = ++j) {
            ...
            results.push(policies.dic[_policies.id] = _policies);
          }
          return results;
        })["catch"](function(err) {
          console.log(err);
      ...
      push: function(_policies) {
        return $http.post("/policies", _policies).then(function(res) {
          alert("Adopted successfully");
          policies.refresh();
          return res.data;
        });
      },
      update: function(_policies) {
        return $http.post("/policies/" + _policies.id, _policies).then(function(res) {
          alert("Updated successfully");
          policies.refresh();
          return res.data;
        });
      },
      "delete": function(_policies) {
        return $http["delete"]("/policies/" + _policies.id).then(function(res) {
          alert("Deleted successfully");
